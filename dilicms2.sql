...
# Dumping database structure for dilicms2
#DROP DATABASE IF EXISTS `dilicms2`;
#CREATE DATABASE IF NOT EXISTS `dilicms2` /*!40100 DEFAULT CHARACTER SET utf8 */;
#USE `dilicms2`;


# Dumping structure for table dilicms2.dili_admins
...
# Dumping data for table dilicms2.dili_admins: 1 rows
/*!40000 ALTER TABLE `dili_admins` DISABLE KEYS */;
INSERT INTO `dili_admins` (`uid`, `username`, `password`, `email`, `role`) VALUES (1, 'admin', 'aebcf178d597d93ff848fd2d6331d5e7', 'dili@cms.com', 1);
/*!40000 ALTER TABLE `dili_admins` ENABLE KEYS */;


# Dumping structure for table dilicms2.dili_attachments
...
# Dumping data for table dilicms2.dili_attachments: 0 rows
/*!40000 ALTER TABLE `dili_attachments` DISABLE KEYS */;
/*!40000 ALTER TABLE `dili_attachments` ENABLE KEYS */;


# Dumping structure for table dilicms2.dili_backend_settings
...
# Dumping data for table dilicms2.dili_backend_settings: 1 rows
/*!40000 ALTER TABLE `dili_backend_settings` DISABLE KEYS */;
INSERT INTO `dili_backend_settings` (`backend_theme`, `backend_lang`, `backend_root_access`, `backend_access_point`, `backend_title`, `backend_logo`) VALUES ('default', 'zh-cn', 1, 'admin', 'dilicms2', 'images/logo.gif');
/*!40000 ALTER TABLE `dili_backend_settings` ENABLE KEYS */;


# Dumping structure for table dilicms2.dili_cate_fields
...
# Dumping data for table dilicms2.dili_cate_fields: 0 rows
/*!40000 ALTER TABLE `dili_cate_fields` DISABLE KEYS */;
/*!40000 ALTER TABLE `dili_cate_fields` ENABLE KEYS */;


# Dumping structure for table dilicms2.dili_cate_models
...
# Dumping data for table dilicms2.dili_cate_models: 0 rows
/*!40000 ALTER TABLE `dili_cate_models` DISABLE KEYS */;
/*!40000 ALTER TABLE `dili_cate_models` ENABLE KEYS */;


# Dumping structure for table dilicms2.dili_fieldtypes
...
# Dumping data for table dilicms2.dili_fieldtypes: 15 rows
...
# Dumping structure for table dilicms2.dili_menus
...
# Dumping data for table dilicms2.dili_menus: 20 rows
...
# Dumping structure for table dilicms2.dili_models
...
# Dumping data for table dilicms2.dili_models: 0 rows
/*!40000 ALTER TABLE `dili_models` DISABLE KEYS */;
/*!40000 ALTER TABLE `dili_models` ENABLE KEYS */;


# Dumping structure for table dilicms2.dili_model_fields
...
# Dumping data for table dilicms2.dili_model_fields: 0 rows
/*!40000 ALTER TABLE `dili_model_fields` DISABLE KEYS */;
/*!40000 ALTER TABLE `dili_model_fields` ENABLE KEYS */;


# Dumping structure for table dilicms2.dili_plugins
...
# Dumping data for table dilicms2.dili_plugins: 0 rows
/*!40000 ALTER TABLE `dili_plugins` DISABLE KEYS */;
/*!40000 ALTER TABLE `dili_plugins` ENABLE KEYS */;


# Dumping structure for table dilicms2.dili_rights
...
# Dumping data for table dilicms2.dili_rights: 49 rows
...
# Dumping structure for table dilicms2.dili_roles
...
# Dumping data for table dilicms2.dili_roles: 1 rows
...
# Dumping structure for table dilicms2.dili_sessions
...
# Dumping data for table dilicms2.dili_sessions: 1 rows
/*!40000 ALTER TABLE `dili_sessions` DISABLE KEYS */;
INSERT INTO `dili_sessions` (`session_id`, `ip_address`, `user_agent`, `last_activity`, `user_data`) VALUES ('51d0ab8b3faf77f5892f086eb8152ee7', '127.0.0.1', 'Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US) Ap', 1321540492, 'a:1:{s:3:"uid";s:1:"1";}');
/*!40000 ALTER TABLE `dili_sessions` ENABLE KEYS */;


# Dumping structure for table dilicms2.dili_site_settings
...
# Dumping data for table dilicms2.dili_site_settings: 1 rows
/*!40000 ALTER TABLE `dili_site_settings` DISABLE KEYS */;
INSERT INTO `dili_site_settings` (`site_name`, `site_domain`, `site_logo`, `site_icp`, `site_terms`, `site_stats`, `site_footer`, `site_status`, `site_close_reason`, `site_keyword`, `site_description`, `site_theme`, `attachment_dir`, `attachment_type`, `attachment_maxupload`) VALUES ('dilicms2', 'http://www.dilicms.com/', 'images/logo.gif', '', '', '', '', 1, '网站维护升级中......', 'dilicms2', 'dilicms2', 'default', 'attachments', '*.jpg;*.gif;*.png', '2097152');
/*!40000 ALTER TABLE `dili_site_settings` ENABLE KEYS */;


# Dumping structure for table dilicms2.dili_validations
...
# Dumping data for table dilicms2.dili_validations: 2 rows
